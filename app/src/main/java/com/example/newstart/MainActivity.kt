...
import com.example.newstart.databinding.ItemBookBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.loadButton.setOnClickListener {
            lifecycleScope.launch(Dispatchers.IO) {
                val books = BookApi.service.getBooks("android")
...
object LeakySingleton {
    ...
    fun getText() = context?.applicationContext?.getString(R.string.app_name)
}
